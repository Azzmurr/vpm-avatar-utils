Shader "Hidden/Locked/.poiyomi/Old Versions/9.1/Poiyomi Pro/e476407972e705e4b88fe9c231807107"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            {
                float3 indirect;
                float3 L0 = float3(unity_SHAr.w, unity_SHAg.w, unity_SHAb.w) + float3(
                    unity_SHBr.z, unity_SHBg.z, unity_SHBb.z) / 3.0;
...
in float4 normal_ST, in float2 normalPan, in float normalUV, in float normalIntensity)
            {
            ...
            float blendColorBurn(float base, float blend)
            {
                return (blend == 0.0)
                                                   ...
                                                   random_uniform_float_only_used_to_stop_compiler_warnings + blend))),
                                               0.0);
            }
    ...
    blendColorDodge(base.b, blend.b));
            ...
            {
                return float3(blendReflect(base.r, blend.r), blendReflect(base.g, blend.g),
    ...
    blendOverlay(base.b, blend.b));
            ...
            {
                return float3(blendVividLight(base.r, blend.r), blendVividLight(base.g, blend.g),
            ...
            {
                return float3(blendHardMix(base.r, blend.r), blendHardMix(base.g, blend.g),
            ...
            {
                return float3(blendLinearLight(base.r, blend.r), blendLinearLight(base.g, blend.g),
            ...
            {
                return float3(blendPinLight(base.r, blend.r), blendPinLight(base.g, blend.g),
            ...
            float blendSoftLight(float base, float blend)
            {
                return (blend < 0.5)
                                                        ...
                                                        : (sqrt(base) * (2.0 * blend - 1.0) + 2.0 * base * (1.0 -
                                                            blend));
            }
        ...
        dot(p, float3(248.3, 315.9, 184.2)))) * 43758.5453);
            ...
            )
            {
                ...
                if (AudioLinkIsAvailable() && (0.0 /*_VertexAudioLinkEnabled*/) && (1.0 /*_AudioLinkAnimToggle*/))
                {
                    ...
                    {
                        ALLocalTranslation = lerp(float4(0, 0, 0, 1), float4(0, 0, 0, 1),
                            audioLinkBands[(0.0 /*_VertexLocalTranslationALBand*/)]);
                    }
                    ...
                    if (any(float4(0, 0, 0, 1)))
                    {
                        CTALRotation.x = AudioLinkGetChronoTime((0.0 /*_VertexLocalRotationCTALTypeX*/),
                     (0.0 /*_VertexLocalRotationCTALBandX*/)) * float4(0, 0, 0, 1).x * 360;
                        CTALRotation.y = AudioLinkGetChronoTime((0.0 /*_VertexLocalRotationCTALTypeY*/),
    (0.0 /*_VertexLocalRotationCTALBandY*/)) * float4(0, 0, 0, 1).
                            y * 360;
                        CTALRotation.z = AudioLinkGetChronoTime((0.0 /*_VertexLocalRotationCTALTypeZ*/),
                                                                              (0.0 /*_VertexLocalRotationCTALBandZ*/)) *
                        float4(0, 0, 0, 1).z * 360;
                    }
                    if (any(float4(0, 0, 0, 0)) || any(float4(0, 0, 0, 0)))
                    {
                        ALScale = lerp(float4(0, 0, 0, 0).xyz + float4(0, 0, 0, 0).w,
                     float4(0, 0, 0, 0).xyz + float4(0, 0, 0, 0).w,
                     audioLinkBands[(0.0 /*_VertexLocalScaleALBand*/)]);
                    }
                    if (any(float4(0, 0, 0, 1)) || any(float4(0, 0, 0, 1)))
                    {
                        ALWorldTranslation = lerp(float4(0, 0, 0, 1), float4(0, 0, 0, 1),
                                                            audioLinkBands[(0.0 /*_VertexWorldTranslationALBand*/)]);
                    }
                    if (any(float4(0, 0, 0, 1)))
                    {
                        ALHeight = lerp(float4(0, 0, 0, 1).x, float4(0, 0, 0, 1).y,
                                                audioLinkBands[(0.0 /*_VertexManipulationHeightBand*/)]);
                    }
                    if (any(float4(0, 0, 0, 1)))
                    {
                        ALRoundingAmount = lerp(float4(0, 0, 0, 1).x, float4(0, 0, 0, 1).y,
                                                            audioLinkBands[(0.0 /*_VertexRoundingRangeBand*/)]);
                    }
                    if ((0.0 /*_VertexSpectrumMotion*/))
                    {
                        ALSpectrumLocalOffset.xyz = lerp(float4(0, 0, 0, 1).xyz, float4(0, 0.1, 0, 1).xyz,
                                      AudioLinkLerpMultiline(ALPASS_DFT + float2(
                                          vertexUV(v, (0.0 /*_VertexSpectrumUV*/))[(0.0 /*_VertexSpectrumUVDirection*/)]
                                          *
                                          AUDIOLINK_ETOTALBINS, 0.)));
                    }
                }
                #endif
                float4 rotation = float4(
                    float4(0, 0, 0, 1).xyz + float3(180, 0, 0) + float4(0, 0, 0, 1) * _Time.x + ALrotation +
                    CTALRotation, float4(0, 0, 0, 1).w);
                v.normal = rotate_with_quaternion(v.normal, rotation.xyz);
                v.tangent.xyz = rotate_with_quaternion(v.tangent.xyz, rotation.xyz);
                v.vertex = transform(
                    v.vertex, float4(0, 0, 0, 1) + float4(ALLocalTranslation, 0) + ALSpectrumLocalOffset, rotation,
                    float4(1, 1, 1, 1) + float4(ALScale, 0));
                o.normal = UnityObjectToWorldNormal(v.normal);
                #if defined(PROP_VERTEXMANIPULATIONHEIGHTMASK) || !defined(OPTIMIZER_ENABLED)
                float3 heightOffset = (tex2Dlod(_VertexManipulationHeightMask,
    float4(
        poiUV(vertexUV(v, (0.0 /*_VertexManipulationHeightMaskUV*/)), float4(1, 1, 0, 0)) +
        float4(0, 0, 0, 0) * _Time.x, 0,
        0))[(0.0 /*_VertexManipulationHeightMaskChannel*/)] - (0.0 /*_VertexManipulationHeightBias*/)) *
                    ((0.0 /*_VertexManipulationHeight*/) + ALHeight) * o.normal;
                #else
                float3 heightOffset = ((0.0 /*_VertexManipulationHeight*/) + ALHeight) * o.normal;
                #endif
                if ((0.0 /*_VertexBarrelMode*/))
                {
                    v.vertex.xz = lerp(v.vertex.xz,
                                              normalize(v.vertex.xz) * (0.2 /*_VertexBarrelWidth*/) + v.vertex.xz * (0.0
                                                  /*_VertexBarrelHeight*/), (0.0 /*_VertexBarrelAlpha*/));
                }
                if ((0.0 /*_VertexSphereMode*/))
                {
                    v.vertex.xyz = lerp(v.vertex.xyz,
                        normalize(v.vertex.xyz + float4(0, 0, 0, 1).xyz) * (1.0 /*_VertexSphereRadius*/) + v.
                   vertex.xyz * (1.0 /*_VertexSphereHeight*/), (0.0 /*_VertexSphereAlpha*/));
                }
                if ((0.0 /*_VertexTornadoMode*/))
                {
                    v.vertex.xz = lerp(v.vertex.xz,
                                   float3(v.vertex.xz + float2(
                                     cos(_Time.y * (5.0 /*_VertexTornadoSpeed*/) + v.
                                         vertex.y * (100.0 /*_VertexTornadoIntensity*/)) * (0.2
                                         /*_VertexTornadoRadius*/),
                                     sin(_Time.y * (5.0 /*_VertexTornadoSpeed*/) + v.
                                vertex.y * (100.0 /*_VertexTornadoIntensity*/)) * (0.2 /*_VertexTornadoRadius*/)),
                                 v.vertex.y),
                                   smoothstep((0.0 /*_VertexTornadoBaseHeight*/),
                                                                (1.0 /*_VertexTornadoTopHeight*/), v.vertex.y));
                }
                v.vertex.xyz += mul(unity_WorldToObject,
                 float4(0, 0, 0, 1).xyz + ALWorldTranslation + heightOffset).xyz;
                ...
                if ((0.0 /*_VertexRoundingEnabled*/))
                {
                    ...
                    if ((0 /*_VertexRoundingSpace*/) == 0)
                    {
                        ...
                        float3 worldRoundPosition = (ceil(worldPos.xyz / divisionAmount) * divisionAmount) -
                            divisionAmount * .5;
            ...
            {
                return frac(
                    sin(glsl_mod(float2(dot(s, float2(127.1,311.7)), dot(s, float2(269.5,183.3))), 3.14159)) *
                    43758.5453);
            }
            #endif
            #if defined(_STOCHASTICMODE_DELIOT_HEITZ)
            ...
            float4x4 HextileUVBWR(float2 uv)
            {
                ...
                float2 cen0 = HextileMakeCenUV(vertex0), cen1 = HextileMakeCenUV(vertex1), cen2 = HextileMakeCenUV(
                                          vertex2);
                                                            ...
                                                            in PoiMods poiMods)
            {
                ...
                {
                    poiFragData.alpha = maskBlend(poiFragData.alpha, poiMods.globalMask[(0.0 /*_AlphaGlobalMask*/) - 1],
                                     (2.0 /*_AlphaGlobalMaskBlendType*/));
                }
            }
            ...
            void calculateGlobalThemes(inout PoiMods poiMods)
            {
                ...
                poiMods.globalColorTheme[0] = float4(
                    ApplyHDRExposure(ModifyViaHSV(themeColor0.rgb,
                        frac((0.0 /*_GlobalThemeHue0*/) + (0.0 /*_GlobalThemeHueSpeed0*/)
                            * _Time.x), (0.0 /*_GlobalThemeSaturation0*/),
                        (0.0 /*_GlobalThemeValue0*/)), themeColorExposures.x),
                    float4(1, 1, 1, 1).a);
                poiMods.globalColorTheme[1] = float4(
                    ApplyHDRExposure(ModifyViaHSV(themeColor1.rgb,
                        frac((0.0 /*_GlobalThemeHue1*/) + (0.0 /*_GlobalThemeHueSpeed1*/) * _Time.x),
                        (0.0 /*_GlobalThemeSaturation1*/), (0.0 /*_GlobalThemeValue1*/)), themeColorExposures.y),
                    float4(1, 1, 1, 1).a);
                poiMods.globalColorTheme[2] = float4(
                    ApplyHDRExposure(ModifyViaHSV(themeColor2.rgb,
                                                                             frac((0.0 /*_GlobalThemeHue2*/) + (0.0
                                                                                 /*_GlobalThemeHueSpeed2*/) * _Time.x),
                                                                             (0.0 /*_GlobalThemeSaturation2*/),
                                                                             (0.0 /*_GlobalThemeValue2*/)),
                                                                themeColorExposures.z), float4(1, 1, 1, 1).a);
                poiMods.globalColorTheme[3] = float4(
                    ApplyHDRExposure(ModifyViaHSV(themeColor3.rgb,
                        frac((0.0 /*_GlobalThemeHue3*/) + (0.0 /*_GlobalThemeHueSpeed3*/) * _Time.x),
                        (0.0 /*_GlobalThemeSaturation3*/), (0.0 /*_GlobalThemeValue3*/)), themeColorExposures.w),
                    float4(1, 1, 1, 1).a);
            }
            ...
            float customDistanceBlend(float base, float blend, float blendType)
            {
                ...
                case 0: return blendNormal(base, blend);
                    break;
                case 2: return blendMultiply(base, blend);
                    break;
                default: return 0;
                    break;
                }
            ...
            void handleGlobalMaskDistance(int index, bool enable, bool type, float minAlpha, float maxAlpha, float min,
                              float max, int blendType, in PoiMesh poiMesh, inout PoiMods poiMods)
            {
                if (enable)
                {
                    float3 position = type ? poiMesh.worldPos : poiMesh.objectPosition;
                    float val = lerp(minAlpha, maxAlpha,
                                                              smoothstep(min, max, distance(
                               position, _WorldSpaceCameraPos)));
                    poiMods.globalMask[index] =
                        saturate(customDistanceBlend(poiMods.globalMask[index], val, blendType));
                }
            }
            ...
            float2 calculatePolarCoordinate(in PoiMesh poiMesh)
            {
                ...
                return float2(
                    radius,
                    angle + distance(poiMesh.uv[(0.0 /*_PolarUV*/)], float4(0.5, 0.5, 0, 0)) * (0.0
                        /*_PolarSpiralPower*/));
            }
            ...
            {
                return float2((0.0 /*_UVModWorldPos0*/) != 3 ? poiMesh.worldPos[(0.0 /*_UVModWorldPos0*/)] : 0.0f,
                                  (2.0 /*_UVModWorldPos1*/) != 3 ? poiMesh.worldPos[(2.0 /*_UVModWorldPos1*/)] : 0.0f);
            }
            ...
            float2 calculatePanosphereUV(in PoiMesh poiMesh)
            {
                float3 viewDirection = normalize(
                    lerp(getCameraPosition().xyz, _WorldSpaceCameraPos.xyz, (1.0 /*_PanoUseBothEyes*/)) - poiMesh.
                                                                  worldPos.xyz) * -1;
                return lerp(MonoPanoProjection(viewDirection), StereoPanoProjection(viewDirection),
                    (0.0 /*_StereoEnabled*/));
            }
                     ...
                     in PoiCam poiCam)
            {
                ...
                #endif
                float2 ToonAddGradient = float2((0.0 /*_LightingAdditiveGradientStart*/),
                                                                 (0.5 /*_LightingAdditiveGradientEnd*/));
                ...
                poiLight.finalLighting = max(
                    POI_BRDF_PBS(1, 0, 0, 0, poiMesh.normals[1], poiCam.viewDir, light, indirectLight).xyz,
                    (0.0 /*_LightingMinLightBrightness*/));
                #endif
                if (poiFragData.toggleVertexLights)
                {
                    ...
                    if (lightingMode == 1)
                    {
                        ...
                        if (ToonAddGradient.x == ToonAddGradient.y) ToonAddGradient.y += 0.0001;
                        vertexLighting = max(vertexLighting,
                                                      lerp(poiLight.vColor[index],
                                   poiLight.vColor[index] * (0.5
                                       /*_LightingAdditivePassthrough*/),
                                   smoothstep(ToonAddGradient.x,
                                                                   ToonAddGradient.y,
                                                                   1 - (.5 * poiLight.vDotNL[index]
                                                                       + .5))) * poiLight.
                                                      detailShadow);
                    }
					}
            ...
            float2 decalUV(float uvNumber, float2 position, half rotation, half rotationSpeed, half2 scale,
                float4 scaleOffset, float depth, in float symmetryMode,
                in float mirroredUVMode, in PoiMesh poiMesh, in PoiCam poiCam)
            {
            ...
            scale / 2 + position + scaleOffset.yw, float2(0, 0),
            float2(1, 1));
                return uv;
            }
            ...
            {
                uv = decalUV(m_DecalTextureUV, m_DecalPosition, m_DecalRotation + decalRotation, m_DecalRotationSpeed,
                             decalScale, m_DecalSideOffset + sideMod, m_DecalDepth, m_DecalSymmetryMode,
                             m_DecalMirroredUVMode, poiMesh,
                             poiCam);
            ...
            {
                uv = decalUV(m_DecalTextureUV, m_DecalPosition, m_DecalRotation + decalRotation, m_DecalRotationSpeed,
                                decalScale * scaleMultiplier, m_DecalSideOffset + sideMod, m_DecalDepth,
                                m_DecalSymmetryMode,
                                m_DecalMirroredUVMode, poiMesh, poiCam);
                float4 dduv = any(fwidth(uv) > .5)
                                                                       ? 0.001
                                                                       : float4(ddx(uv) * m_DecalTexture_ST.x,
                                                                           ddy(uv) * m_DecalTexture_ST.y);
                decalColor = tex2D(decalTexture, poiUV(uv, m_DecalTexture_ST) + m_DecalTexturePan * _Time.x, dduv.xy,
                                     dduv.zw) * float4(
        ...
        m_DecalHueShiftColorSpace);
                                                              ...
                                                              float2 scaleMultiplier = float2(1, 1))
            {
                ...
                decalColor.rgb = decalHueShift(m_DecalHueShiftEnabled, decalColor.rgb,
                                                                     ...
                                                                     m_DecalHueAngleStrength, m_DecalHueShiftSpeed,
                                                                     m_DecalHueShiftColorSpace);
                decalColor.a *= decalMask[m_DecalMaskChannel] * applyTilingClipping(m_DecalTiled, uv);
            }
            ...
            {
                uv = decalUV(m_DecalTextureUV, m_DecalPosition, m_DecalRotation + decalRotation, m_DecalRotationSpeed,
                 decalScale * scaleMultiplier,
                 m_DecalSideOffset + sideMod, m_DecalDepth,
                 m_DecalSymmetryMode, m_DecalMirroredUVMode, poiMesh,
                 poiCam);
                float4 dduv = any(fwidth(uv) > .5)
                                                                  ? 0.001
                                                                  : float4(ddx(uv) * m_DecalTexture_ST.x,
                                                 ddy(uv) * m_DecalTexture_ST.y);
                decalColor = tex2D(decalTexture, poiUV(uv, m_DecalTexture_ST) + m_DecalTexturePan * _Time.x, dduv.xy,
                    dduv.zw) * float4(poiThemeColor(poiMods, m_DecalColor.rgb, m_DecalColorThemeIndex), m_DecalColor.a);
                decalColor.a *= decalMask[m_DecalMaskChannel] * applyTilingClipping(m_DecalTiled, uv);
            }
                      ...
                      in PoiMesh poiMesh, in PoiCam poiCam)
            {
                ...
                float4 sample0 = tex2D(decalTexture, poiUV(uvSample0, m_DecalTexture_ST) + m_DecalTexturePan * _Time.x,
                                       dduvSample0.xy, dduvSample0.zw) * float4(
                    poiThemeColor(poiMods, m_DecalColor.rgb, m_DecalColorThemeIndex), m_DecalColor.a);
                float4 sample1 = tex2D(decalTexture, poiUV(uvSample1, m_DecalTexture_ST) + m_DecalTexturePan * _Time.x,
                                       dduvSample1.xy, dduvSample1.zw) * float4(
                    poiThemeColor(poiMods, m_DecalColor.rgb, m_DecalColorThemeIndex), m_DecalColor.a);
            ...
            #ifdef POI_AUDIOLINK
            audioLinkDecalEmission= lerp(m_AudioLinkDecalEmission.x, m_AudioLinkDecalEmission.y, poiMods.audioLink [
                m_AudioLinkDecalEmissionBand]) * poiMods.audioLinkAvailable;
            ...
            audioLinkDecalAlpha= lerp(m_AudioLinkDecalAlpha.x, m_AudioLinkDecalAlpha.y, poiMods.audioLink [
                m_AudioLinkDecalAlphaBand]) * poiMods.audioLinkAvailable;
            #endif
            ...
            poiFragData.baseColor.rgb= lerp(poiFragData.baseColor.rgb, customBlend (poiFragData.baseColor.rgb
, decalColor.rgb, m_DecalBlendType), decalAlphaMixed);
            poiFragData.emission+= decalColor.rgb* decalColor.a* max(m_DecalEmissionStrength + audioLinkDecalEmission,
 0);
				}
            ...
            float4 decalMask = POI2D_SAMPLER_PAN(_DecalMask, _MainTex,
                                                 poiUV(poiMesh.uv[(0.0 /*_DecalMaskUV*/)], float4(1,1,0,0)),
                                                 float4(0,0,0,0));
            #else
            float4 decalMask = 1;
            #endif
            ...
            float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
            {
                ...
                float4 mainTexture = POI2D_SAMPLER_PAN_STOCHASTIC(_MainTex, _MainTex, mainUV, float4(0,0,0,0),
                                                                  (0.0 /*_MainTexStochastic*/));
                #if defined(PROP_BUMPMAP) || !defined(OPTIMIZER_ENABLED)
                poiMesh.tangentSpaceNormal = UnpackScaleNormal(
                    POI2D_SAMPLER_PAN_STOCHASTIC(_BumpMap, _MainTex,
                                                 poiUV(poiMesh.uv[(0.0 /*_BumpMapUV*/)].xy, float4(1,1,0,0)),
                                                 float4(0,0,0,0), (0.0 /*_BumpMapStochastic*/)), (1.0 /*_BumpScale*/));
                #else
                ...
                #if defined(PROP_LIGHTINGAOMAPS) || !defined(OPTIMIZER_ENABLED)
                float4 AOMaps = POI2D_SAMPLER_PAN(_LightingAOMaps, _MainTex,
                                                  poiUV(poiMesh.uv[(0.0 /*_LightingAOMapsUV*/)], float4(1,1,0,0)),
                                                  float4(0,0,0,0));
                poiLight.occlusion = min(
                    min(min(lerp(1, AOMaps.r, (1.0 /*_LightDataAOStrengthR*/)),
                            lerp(1, AOMaps.g, (0.0 /*_LightDataAOStrengthG*/))),
                        lerp(1, AOMaps.b, (0.0 /*_LightDataAOStrengthB*/))),
                    lerp(1, AOMaps.a, (0.0 /*_LightDataAOStrengthA*/)));
                #else
                poiLight.occlusion = 1;
                #endif
                if ((0.0 /*_LightDataAOGlobalMaskR*/) > 0)
                {
                    poiLight.occlusion = maskBlend(poiLight.occlusion,
                                                   poiMods.globalMask[(0.0 /*_LightDataAOGlobalMaskR*/) - 1],
                                                   (2.0 /*_LightDataAOGlobalMaskBlendTypeR*/));
                }
                #if defined(PROP_LIGHTINGDETAILSHADOWMAPS) || !defined(OPTIMIZER_ENABLED)
                float4 DetailShadows = POI2D_SAMPLER_PAN(_LightingDetailShadowMaps, _MainTex,
                                                         poiUV(poiMesh.uv[(0.0 /*_LightingDetailShadowMapsUV*/)], float4
                                                             (1,1,0,0)), float4(0,0,0,0));
                #ifndef POI_PASS_ADD
                poiLight.detailShadow = lerp(1, DetailShadows.r, (1.0 /*_LightingDetailShadowStrengthR*/)) *
                    lerp(1, DetailShadows.g, (0.0 /*_LightingDetailShadowStrengthG*/)) * lerp(
                        1, DetailShadows.b, (0.0 /*_LightingDetailShadowStrengthB*/)) * lerp(
                        1, DetailShadows.a, (0.0 /*_LightingDetailShadowStrengthA*/));
                #else
                poiLight.detailShadow = lerp(1, DetailShadows.r, (1.0 /*_LightingAddDetailShadowStrengthR*/)) *
                    lerp(1, DetailShadows.g, (0.0 /*_LightingAddDetailShadowStrengthG*/)) * lerp(
                        1, DetailShadows.b, (0.0 /*_LightingAddDetailShadowStrengthB*/)) * lerp(
                        1, DetailShadows.a, (0.0 /*_LightingAddDetailShadowStrengthA*/));
                #endif
                #else
                ...
                {
                    poiLight.detailShadow = maskBlend(poiLight.detailShadow,
                                                      poiMods.globalMask[(0.0 /*_LightDataDetailShadowGlobalMaskR*/) -
                                                          1], (2.0 /*_LightDataDetailShadowGlobalMaskBlendTypeR*/));
                }
                #if defined(PROP_LIGHTINGSHADOWMASKS) || !defined(OPTIMIZER_ENABLED)
                float4 ShadowMasks = POI2D_SAMPLER_PAN(_LightingShadowMasks, _MainTex,
                                                       poiUV(poiMesh.uv[(0.0 /*_LightingShadowMasksUV*/)], float4(1,1,0,
                                                           0)), float4(0,0,0,0));
                poiLight.shadowMask = lerp(1, ShadowMasks.r, (1.0 /*_LightingShadowMaskStrengthR*/)) *
                    lerp(1, ShadowMasks.g, (0.0 /*_LightingShadowMaskStrengthG*/)) * lerp(
                        1, ShadowMasks.b, (0.0 /*_LightingShadowMaskStrengthB*/)) * lerp(
                        1, ShadowMasks.a, (0.0 /*_LightingShadowMaskStrengthA*/));
                #else
                poiLight.shadowMask = 1;
                #endif
                if ((0.0 /*_LightDataShadowMaskGlobalMaskR*/) > 0)
                {
                    poiLight.shadowMask = maskBlend(poiLight.shadowMask,
                                                    poiMods.globalMask[(0.0 /*_LightDataShadowMaskGlobalMaskR*/) - 1],
                                                    (2.0 /*_LightDataShadowMaskGlobalMaskBlendTypeR*/));
                }
                #ifdef UNITY_PASS_FORWARDBASE
                ...
                for (int index = 0; index < 4; index++)
                {
                    ...
                    poiLight.vColor[index] = (1.0 /*_LightingAdditiveLimited*/)
                                                 ? MaxLuminance(
                                                     unity_LightColor[index].rgb * poiLight.vAttenuation[index],
                                                     (1.0 /*_LightingAdditiveLimit*/))
                                                 : unity_LightColor[index].rgb * poiLight.vAttenuation[index];
                    poiLight.vColor[index] = lerp(poiLight.vColor[index],
                                                  dot(poiLight.vColor[index], float3(0.299, 0.587, 0.114)),
                                                  (0.0 /*_LightingAdditiveMonochromatic*/));
                ...
                if ((0.0 /*_LightingColorMode*/) == 0) // Poi Custom Light Color
                {
                    ...
                    poiLight.indirectColor = BetterSH9(
                        float4(lerp(0, poiMesh.normals[1], (0.0 /*_LightingIndirectUsesNormals*/)), 1));
                }
                ...
                {
                    poiLight.indirectColor = saturate(max(half3(0.05, 0.05, 0.05) * (1.0 /*_Unlit_Intensity*/),
                                                          max(ShadeSH9(half4(0.0, 0.0, 0.0, 1.0)),
                                                              ShadeSH9(half4(0.0, -1.0, 0.0, 1.0)).rgb) * (1.0
                                                              /*_Unlit_Intensity*/)));
                ...
                if ((0.0 /*_LightingDirectionMode*/) == 5) // View Direction
                {
                    ...
                    float yawOffset_Rads = radians(!IsInMirror()
                    ...
                    float pitchOffset_Rads = radians(!IsInMirror()
                                                         ? (0.0 /*_LightingViewDirOffsetPitch*/)
                                                         : -(0.0 /*_LightingViewDirOffsetPitch*/));
                ...
                if (lightMapMode == 0)
                {
                    ...
                    float3 ShadeSH9Minus = float3(unity_SHAr.w, unity_SHAg.w, unity_SHAb.w) + float3(
                        unity_SHBr.z, unity_SHBg.z, unity_SHBb.z) / 3.0;
                    ...
                    float bw_directLighting = (((poiLight.nDotL * 0.5 + 0.5) * bw_lightColor * lerp(
                        ...
                        ShadeSH9(float4(poiMesh.normals[1], 1)), greyScaleVector));
                ...
                else
                {
                    poiLight.directColor = max(poiLight.directColor,
                                               poiLight.directColor * min(
                                                   10000, ((0.0 /*_LightingMinLightBrightness*/) * rcp(
                                                       calculateluminance(poiLight.directColor)))));
                    poiLight.indirectColor = max(poiLight.indirectColor,
                                                 poiLight.indirectColor * min(
                                                     10000, ((0.0 /*_LightingMinLightBrightness*/) * rcp(
                                                         calculateluminance(poiLight.indirectColor)))));
                }
                poiLight.directColor = lerp(poiLight.directColor,
                                            dot(poiLight.directColor, float3(0.299, 0.587, 0.114)),
                                            (0.0 /*_LightingMonochromatic*/));
                poiLight.indirectColor = lerp(poiLight.indirectColor,
                                              dot(poiLight.indirectColor, float3(0.299, 0.587, 0.114)),
                                              (0.0 /*_LightingMonochromatic*/));
                ...
                {
                    poiLight.directColor = poiThemeColor(poiMods, float4(1, 1, 1, 1),
                                                         (0.0 /*_LightingForcedColorThemeIndex*/));
                }
                #ifdef UNITY_PASS_FORWARDBASE
                ...
                poiLight.directColor = (1.0 /*_LightingAdditiveLimited*/)
                                           ? MaxLuminance(_LightColor0.rgb * poiLight.attenuation,
                                                          (1.0 /*_LightingAdditiveLimit*/))
                ...
                poiLight.indirectColor = (1.0 /*_LightingAdditiveLimited*/)
                                             ? MaxLuminance(poiLight.indirectColor, (1.0 /*_LightingAdditiveLimit*/))
                                             : poiLight.indirectColor;
                #endif
                poiLight.directColor = lerp(poiLight.directColor,
                                            dot(poiLight.directColor, float3(0.299, 0.587, 0.114)),
                ...
                poiLight.vertexNDotV = abs(dot(poiMesh.normals[0], poiCam.viewDir));
                poiLight.vertexNDotH = max(0.00001, dot(poiMesh.normals[0], poiLight.halfDir));
                if ((0.0 /*_LightingMapMode*/) == 0 || (0.0 /*_LightingMapMode*/) == 1 || (0.0 /*_LightingMapMode*/) ==
                    2)
                {
                ...
                #endif
                poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(1, 1, 1, 0.4470588).rgb,
                                                                        (0.0 /*_ColorThemeIndex*/));
                poiFragData.alpha = mainTexture.a * float4(1, 1, 1, 0.4470588).a;
                #if defined(PROP_ALPHAMASK) || !defined(OPTIMIZER_ENABLED)
                if ((2.0 /*_MainAlphaMaskMode*/))
                {
                    float alphaMask = POI2D_SAMPLER_PAN(_AlphaMask, _MainTex,
                                                        poiUV(poiMesh.uv[(0.0 /*_AlphaMaskUV*/)], float4(1,1,0,0)),
                                                        float4(0,0,0,0).xy).r;
                    alphaMask = saturate(
                        alphaMask * (1.0 /*_AlphaMaskBlendStrength*/) + ((0.0 /*_AlphaMaskInvert*/)
                                                                             ? _AlphaMaskValue * -1
                                                                             : (0.0 /*_AlphaMaskValue*/)));
                ...
                {
                    applyToGlobalMask(poiMods, (0.0 /*_ShadingRampedLightMapApplyGlobalMaskIndex*/) - 1,
                                      (2.0 /*_ShadingRampedLightMapApplyGlobalMaskBlendType*/),
                                      poiLight.rampedLightMap);
                }
                if ((0.0 /*_ShadingRampedLightMapInverseApplyGlobalMaskIndex*/) > 0)
                {
                    applyToGlobalMask(poiMods, (0.0 /*_ShadingRampedLightMapInverseApplyGlobalMaskIndex*/) - 1,
                                      (2.0 /*_ShadingRampedLightMapInverseApplyGlobalMaskBlendType*/),
                                      1 - poiLight.rampedLightMap);
                }
    ...
    const float4 destinationColor, const float4 blendFactor)
            ...
            float blendColorBurn(float base, float blend)
            {
                ...
                ? blend
                : max((1.0 - ((1.0 - base) * rcp(
                                                                                   random_uniform_float_only_used_to_stop_compiler_warnings
                                                                                   + blend))), 0.0);
            }
        ...
        dot(p, float2(248.3, 315.9)))) * 43758.5453);
            ...
            {
                return mul(float4(color, 1), mul(brightnessMatrix(brightness),
                                                                             mul(contrastMatrix(contrast),
                                  saturationMatrix(saturation)))).rgb;
            }
        ...
        (0.0 /*_VertexLocalRotationCTALBandX*/)) * float4(0, 0, 0, 1).x * 360;
                        CTALRotation.y = AudioLinkGetChronoTime((0.0 /*_VertexLocalRotationCTALTypeY*/),
                            ...
                            y * 360;
                        CTALRotation.z = AudioLinkGetChronoTime((0.0 /*_VertexLocalRotationCTALTypeZ*/),
                                               (0.0 /*_VertexLocalRotationCTALBandZ*/)) * float4(0, 0, 0, 1).z * 360;
                    }
                    if (any(float4(0, 0, 0, 0)) || any(float4(0, 0, 0, 0)))
                    {
                        ALScale = lerp(float4(0, 0, 0, 0).xyz + float4(0, 0, 0, 0).w,
                ...
                float3 heightOffset = (tex2Dlod(_VertexManipulationHeightMask,
                                                 float4(
                                                     poiUV(vertexUV(v, (0.0 /*_VertexManipulationHeightMaskUV*/)),
                                                         float4(1, 1, 0, 0)) +
                                                     float4(0, 0, 0, 0) * _Time.x, 0,
                                                     0))[(0.0 /*_VertexManipulationHeightMaskChannel*/)] - (0.0
                ...
                {
                    v.vertex.xz = lerp(v.vertex.xz,
                                                                              normalize(v.vertex.xz) * (0.2
                                                                                  /*_VertexBarrelWidth*/) + v.vertex.xz
                                                                              * (0.0
                                                                                  /*_VertexBarrelHeight*/),
                                                                              (0.0 /*_VertexBarrelAlpha*/));
                }
                if ((0.0 /*_VertexSphereMode*/))
                {
                    v.vertex.xyz = lerp(v.vertex.xyz,
    ...
    vertex.y * (100.0 /*_VertexTornadoIntensity*/)) * (0.2 /*_VertexTornadoRadius*/),
                      sin(_Time.y * (5.0 /*_VertexTornadoSpeed*/) + v.
                       vertex.y * (100.0 /*_VertexTornadoIntensity*/)) * (0.2 /*_VertexTornadoRadius*/)), v.vertex.y),
                                                       smoothstep((0.0 /*_VertexTornadoBaseHeight*/),
                                                                   (1.0 /*_VertexTornadoTopHeight*/), v.vertex.y));
                }
                v.vertex.xyz += mul(unity_WorldToObject,
...
unity_DynamicLightmapST);
                     ...
                     in PoiCam poiCam)
            {
                ...
                if (poiFragData.toggleVertexLights)
                {
                    ...
                    {
                        vertexLighting = max(vertexLighting,
            poiLight.vColor[index] * poiLight.vSaturatedDotNL[index] * poiLight.detailShadow);
                        // Realistic
                    }
                    if (lightingMode == 1)
                    {
                        ...
                        vertexLighting = max(vertexLighting,
                            lerp(poiLight.vColor[index],
                                             poiLight.vColor[index] * (0.5 /*_LightingAdditivePassthrough*/),
                                             smoothstep(ToonAddGradient.x, ToonAddGradient.y,
                                                          1 - (.5 * poiLight.vDotNL[index] + .5))) * poiLight.
                            detailShadow);
                    }
					}
                    float3 mixedLight = poiLight.finalLighting;
...
scale / 2 + position + scaleOffset.yw, float2(0, 0), float2(1, 1));
                 ...
                 in PoiMesh poiMesh, in PoiCam poiCam)
            {
                ...
                float2 uvSample0 = decalUV(m_DecalTextureUV, m_DecalPosition + positionOffset,
                           ...
                           m_DecalDepth, m_DecalSymmetryMode, m_DecalMirroredUVMode, poiMesh, poiCam);
                float2 uvSample1 = decalUV(m_DecalTextureUV, m_DecalPosition - positionOffset,
m_DecalRotation + decalRotation, m_DecalRotationSpeed,
decalScale, m_DecalSideOffset + sideMod, m_DecalDepth,
m_DecalSymmetryMode, m_DecalMirroredUVMode, poiMesh,
poiCam);
                float4 dduvSample0 = any(fwidth(uvSample0) > .5)
                                        ? 0.001
                ...
                float4 dduvSample1 = any(fwidth(uvSample1) > .5)
    ? 0.001
    : float4(ddx(uvSample1) * m_DecalTexture_ST.x, ddy(uvSample1) * m_DecalTexture_ST.y);
                float4 sample0 = tex2D(decalTexture, poiUV(uvSample0, m_DecalTexture_ST) + m_DecalTexturePan * _Time.x,
                                       dduvSample0.xy, dduvSample0.zw) * float4(
                    poiThemeColor(poiMods, m_DecalColor.rgb, m_DecalColorThemeIndex), m_DecalColor.a);
                float4 sample1 = tex2D(decalTexture, poiUV(uvSample1, m_DecalTexture_ST) + m_DecalTexturePan * _Time.x,
...
blendPinLight(base.b, blend.b));
            ...
            {
                return (blend < 0.5)
                                                                 ? (2.0 * base * blend + base * base * (1.0 -
                                                                     2.0 * blend))
                                                                 : (sqrt(base) * (2.0 * blend - 1.0) + 2.0 *
                                                                     base * (1.0 - blend));
            }
...
dot(p, float2(248.3, 315.9)))) * 43758.5453);
            ...
            float3 randomFloat3WiggleRange(float2 Seed, float Range, float wiggleSpeed, float timeOffset)
            {
                ...
                return float3(sin(((_Time.x + timeOffset) + rando.x * PI) * speed),
                                    sin(((_Time.x + timeOffset) + rando.y * PI) * speed),
                                    sin(((_Time.x + timeOffset) + rando.z * PI) * speed)) *
                    Range;
            }
                ...
                if (AudioLinkIsAvailable() && (0.0 /*_VertexAudioLinkEnabled*/) && (1.0 /*_AudioLinkAnimToggle*/))
                {
                    ...
                    if (any(float4(0, 0, 0, 1)))
                    {
                        CTALRotation.x = AudioLinkGetChronoTime((0.0 /*_VertexLocalRotationCTALTypeX*/),
                          (0.0 /*_VertexLocalRotationCTALBandX*/)) * float4(0, 0, 0, 1).x * 360;
                        CTALRotation.y = AudioLinkGetChronoTime((0.0 /*_VertexLocalRotationCTALTypeY*/),
                          (0.0 /*_VertexLocalRotationCTALBandY*/)) * float4(0, 0, 0, 1).y * 360;
                        CTALRotation.z = AudioLinkGetChronoTime((0.0 /*_VertexLocalRotationCTALTypeZ*/),
                                         (0.0 /*_VertexLocalRotationCTALBandZ*/)) * float4(0, 0, 0, 1).z * 360;
                    }
                    if (any(float4(0, 0, 0, 0)) || any(float4(0, 0, 0, 0)))
...
float4(
    ...
    0))[(0.0 /*_VertexManipulationHeightMaskChannel*/)] - (0.0 /*_VertexManipulationHeightBias*/)) * ((
                ...
                {
                    v.vertex.xz = lerp(v.vertex.xz,
                                                                 normalize(v.vertex.xz) * (0.2 /*_VertexBarrelWidth*/) +
                                                                 v.vertex.xz * (0.0
                                                                     /*_VertexBarrelHeight*/),
                                                                 (0.0 /*_VertexBarrelAlpha*/));
                }
                ...
                {
                    v.vertex.xyz = lerp(v.vertex.xyz,
                                                       normalize(v.vertex.xyz + float4(0, 0, 0, 1).xyz) * (1.0
                                                           /*_VertexSphereRadius*/) + v.vertex.xyz * (1.0
                                                           /*_VertexSphereHeight*/), (0.0 /*_VertexSphereAlpha*/));
                }
                if ((0.0 /*_VertexTornadoMode*/))
                {
                    v.vertex.xz = lerp(v.vertex.xz,
                                       float3(v.vertex.xz + float2(
                                                  cos(_Time.y * (5.0 /*_VertexTornadoSpeed*/) + v.vertex.y * (100.0
                                                      /*_VertexTornadoIntensity*/)) * (0.2 /*_VertexTornadoRadius*/),
                                                  sin(_Time.y * (5.0 /*_VertexTornadoSpeed*/) + v.vertex.y * (100.0
                                                      /*_VertexTornadoIntensity*/)) * (0.2 /*_VertexTornadoRadius*/)),
                                              v.vertex.y),
                                       smoothstep((0.0 /*_VertexTornadoBaseHeight*/), (1.0 /*_VertexTornadoTopHeight*/),
                                                  v.vertex.y));
                }
                v.vertex.xyz += mul(unity_WorldToObject,
                                    float4(0, 0, 0, 1).xyz + ALWorldTranslation + heightOffset).xyz;
                                          ...
                                          float max, int blendType, in PoiMesh poiMesh, inout PoiMods poiMods)
            {
                if (enable)
                {
                    float3 position = type ? poiMesh.worldPos : poiMesh.objectPosition;
                    float val = lerp(minAlpha, maxAlpha,
                                     smoothstep(min, max, distance(position, _WorldSpaceCameraPos)));
                    poiMods.globalMask[index] =
                        saturate(customDistanceBlend(poiMods.globalMask[index], val, blendType));
                }
            }
